...
2. Pengguna gratis mendapatkan ${setting.limit?.free || 15} limit / hari dan akan direset jam 12 malam.
...
2. Free users get ${setting.limit?.free || 15} / day and will reset after 12 hours
...
12. All Terms & Conditions are subject to change at any time without prior notice.`
        ...
        await (setting.fakereply ? erlic.sendMessageModify(m.chat, caption, m, {
            title: global.header,
            body: global.footer,
            thumbnailUrl: setting.cover,
            largeThumb: true,
            expiration: m.expiration
        }) : erlic.reply(m.chat, caption, m, {
            expiration: m.expiration
        }))
    },
    location: 'plugins/special/rules.js'
}